...
func Router() *mux.Router {
	...
	router.HandleFunc("/api/myservices", middleware.GetAllMyServices).Methods("POST", "OPTIONS")
	router.HandleFunc("/api/otherservices", middleware.GetAllOtherServices).Methods("POST", "OPTIONS")
